  ...
  return (
    ...
    <div className='p-4 max-w-lg mx-auto'>
      ...
      >
        ...
        <Link
          to='/create-listing'
          className='bg-green-600 text-white py-2 rounded-lg text-center uppercase'
        >
          Create New Listing
        </Link>
      ...
      <button
        ...
        className='mt-6 w-full text-blue-700 underline'
      >
        View My Listings
      </button>
        ...
        <div className='mt-6 flex flex-col gap-4'>
          ...
          {listings.map((item) => (
            ...
            >
              ...
              <Link
                to={`/listing/${item._id}`}
                className='flex-1 ml-4 text-slate-800 hover:underline'
              >
                {item.name}
              </Link>
